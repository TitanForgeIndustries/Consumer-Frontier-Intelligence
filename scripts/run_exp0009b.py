...
DEFAULT_OUTPUT = data_path("Results", "CFI-Eval-0009B-Conditioned-Latent-State")
...
def collect_trace(
    ...
    # interactions in some PyTorch + quantization combinations.
    token_embeddings = hidden_states[0][0].float().cpu()
